# ☁️ Terraform Infrastructure Patterns
...
### 1. Remote State
**📍 Location:** [`/remote-state`](./remote-state)


## 🤝 Contributing

If you have a new pattern or improvement to share:
1.  Create a new folder for your example.
2.  Include a `README.md` explaining the "Why" and "How".
